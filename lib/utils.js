 ...
 * @param {Function} cb
 */
utils.downloadBin = function (opts, cb) {
 ...
 * @param {Function} cb
 */
utils.downloadText = function (opts, cb) {
 ...
 * @param {Function} cb
 */
utils.downloadOne = function (opts, cb) {
    opts.chrome.Network.getResponseBody(opts.items[0], function (err, resp) {
        if (err) {
            return cb(err);
        }
        cb(null, resp.body);
