...
module.exports = function (cli, config) {
    ...
    Chrome(function (chrome) {
        ...
        function singleFileContents(item) {
            return downloadItems([item], conf).map(function (x) {
         ...
         */
        var afterPageLoad = netreq().skipUntil(obs.Page.loadEventFired).filter(function (x) {
            return isValidType(x, config.whitelist);
        });
        ...
        .flatMap(function (tasks) {
            return downloadItemsAndWrite(tasks, conf).map(function (files) {
                return {
                    files: files,
                    tasks: tasks
                };
         ...
         */
        beforePageLoad.subscribe(function (x) {
         ...
         */
        afterPageLoad.subscribe(function (x) {
